...
class AccessAnalysisResult(Object):
    ...
    accessors: list[Any]
    additional_restrictions: list[Any] | None = None
...
class IdentityActivityMetrics(Object):
    first_seen_time: int | None = None
    last_authentication_time: int | None = None
    last_seen_time: int | None = None
    password_last_used_time: int | None = None
    programmatic_credentials: list[Any] | None = None
...
class Metadata(Object):
    ...
    modified_time: int | None = None
    original_event_uid: str | None = None
...
class Module(Object):
    ...
    file: Any | None = None
    function_invocation: Any | None = None
...
class NetworkEndpoint(Endpoint):
    class NetworkScopeId(SiblingEnum):
        UNKNOWN = 0
        INTERNAL = 1
        EXTERNAL = 2
        OTHER = 99
    ...
    network_scope_id: int | None = None
    port: Any | None = None
