...
class DeviceConfigStateChange(Discovery):
    ...
    @classmethod
    def validate_prev_security_level(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "prev_security_level" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("prev_security_level")
        return instance
    ...
    @model_validator(mode="wrap")
    @classmethod
    def validate_security_level(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        instance = handler(data)
        if instance.__pydantic_extra__ and "security_level" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("security_level")
        return instance
