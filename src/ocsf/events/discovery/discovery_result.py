...
class DiscoveryResult(BaseEvent):
    ...
    @classmethod
    def validate_query_result(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "query_result" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("query_result")
        return instance
