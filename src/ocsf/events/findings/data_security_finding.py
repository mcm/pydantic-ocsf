...
class DataSecurityFinding(Finding):
    ...
    @model_validator(mode="wrap")
    @classmethod
    def validate_risk_level(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        instance = handler(data)
        if instance.__pydantic_extra__ and "risk_level" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("risk_level")
        return instance
