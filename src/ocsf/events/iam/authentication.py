...
class Authentication(IAM):
    ...
    @classmethod
    def validate_account_switch_type(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "account_switch_type" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("account_switch_type")
        return instance
    ...
    @model_validator(mode="wrap")
    @classmethod
    def validate_auth_protocol(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        instance = handler(data)
        if instance.__pydantic_extra__ and "auth_protocol" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("auth_protocol")
        return instance
    ...
    @model_validator(mode="wrap")
    @classmethod
    def validate_logon_type(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        instance = handler(data)
        if instance.__pydantic_extra__ and "logon_type" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("logon_type")
        return instance
