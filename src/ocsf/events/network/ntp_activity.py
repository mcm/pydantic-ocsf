...
class NtpActivity(Network):
    ...
    @classmethod
    def validate_stratum(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "stratum" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("stratum")
        return instance
