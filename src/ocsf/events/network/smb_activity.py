...
class SmbActivity(Network):
    ...
    @classmethod
    def validate_share_type(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "share_type" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("share_type")
        return instance
