...
class SshActivity(Network):
    ...
    @classmethod
    def validate_auth_type(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "auth_type" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("auth_type")
        return instance
