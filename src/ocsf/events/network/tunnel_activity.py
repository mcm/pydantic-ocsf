...
class TunnelActivity(Network):
    ...
    @classmethod
    def validate_tunnel_type(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "tunnel_type" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("tunnel_type")
        return instance
