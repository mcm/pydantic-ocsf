...
class EventLogActivity(System):
    ...
    @classmethod
    def validate_log_type(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "log_type" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("log_type")
        return instance
