...
class ProcessActivity(System):
    ...
    @classmethod
    def validate_injection_type(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "injection_type" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("injection_type")
        return instance
