...
from pydantic import AnyUrl, ModelWrapValidatorHandler, computed_field, model_validator
...
class DataClassification(Object):
    ...
    @classmethod
    def validate_category(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "category" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("category")
        return instance
    ...
    @model_validator(mode="wrap")
    @classmethod
    def validate_confidentiality(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        instance = handler(data)
        if instance.__pydantic_extra__ and "confidentiality" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("confidentiality")
        return instance
