...
class DataSecurity(DataClassification):
    ...
    @classmethod
    def validate_data_lifecycle_state(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "data_lifecycle_state" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("data_lifecycle_state")
        return instance
    ...
    @model_validator(mode="wrap")
    @classmethod
    def validate_detection_system(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        instance = handler(data)
        if instance.__pydantic_extra__ and "detection_system" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("detection_system")
        return instance
