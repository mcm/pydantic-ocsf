...
class DeviceHwInfo(Object):
    ...
    @classmethod
    def validate_cpu_architecture(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "cpu_architecture" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("cpu_architecture")
        return instance
