...
class DigitalSignature(Object):
    ...
    @classmethod
    def validate_algorithm(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "algorithm" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("algorithm")
        return instance
