...
class File(Entity):
    ...
    @model_validator(mode="wrap")
    @classmethod
    def validate_drive_type(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        instance = handler(data)
        if instance.__pydantic_extra__ and "drive_type" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("drive_type")
        return instance
