...
class KbArticle(Object):
    ...
    @classmethod
    def validate_install_state(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "install_state" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("install_state")
        return instance
