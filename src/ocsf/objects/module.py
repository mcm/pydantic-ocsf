...
class Module(Object):
    ...
    @classmethod
    def validate_load_type(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "load_type" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("load_type")
        return instance
