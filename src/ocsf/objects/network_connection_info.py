...
class NetworkConnectionInfo(Object):
    ...
    @classmethod
    def validate_boundary(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "boundary" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("boundary")
        return instance
    ...
    @model_validator(mode="wrap")
    @classmethod
    def validate_direction(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        instance = handler(data)
        if instance.__pydantic_extra__ and "direction" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("direction")
        return instance
    ...
    @model_validator(mode="wrap")
    @classmethod
    def validate_protocol_ver(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        instance = handler(data)
        if instance.__pydantic_extra__ and "protocol_ver" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("protocol_ver")
        return instance
