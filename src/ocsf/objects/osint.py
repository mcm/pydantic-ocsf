...
from pydantic import AnyUrl, IPvAnyNetwork, ModelWrapValidatorHandler, computed_field, model_validator
...
class Osint(Object):
    ...
    @model_validator(mode="wrap")
    @classmethod
    def validate_detection_pattern_type(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        instance = handler(data)
        if instance.__pydantic_extra__ and "detection_pattern_type" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("detection_pattern_type")
        return instance
