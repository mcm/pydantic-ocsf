...
class Process(ProcessEntity):
    ...
    @classmethod
    def validate_integrity(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "integrity" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("integrity")
        return instance
