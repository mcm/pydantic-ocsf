...
class QueryEvidence(OcsfObject):
    ...
    @classmethod
    def validate_query_type(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "query_type" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("query_type")
        return instance
