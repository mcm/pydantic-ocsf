...
class SoftwareComponent(Object):
    ...
    @classmethod
    def validate_relationship(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "relationship" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("relationship")
        return instance
