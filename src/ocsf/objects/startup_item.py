...
class StartupItem(OcsfObject):
    ...
    @classmethod
    def validate_run_modes(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "run_modes" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("run_modes")
        return instance
    ...
    @model_validator(mode="wrap")
    @classmethod
    def validate_run_state(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        instance = handler(data)
        if instance.__pydantic_extra__ and "run_state" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("run_state")
        return instance
    ...
    @model_validator(mode="wrap")
    @classmethod
    def validate_start_type(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        instance = handler(data)
        if instance.__pydantic_extra__ and "start_type" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("start_type")
        return instance
