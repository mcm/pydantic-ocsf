...
class Url(Object):
    ...
    @classmethod
    def validate_categories(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "categories" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("categories")
        return instance
