...
from pydantic import EmailStr, IPvAnyNetwork, ModelWrapValidatorHandler, computed_field, model_validator
...
class Whois(Object):
    ...
    @classmethod
    def validate_dnssec_status(cls, data: dict[str, Any], handler: ModelWrapValidatorHandler) -> Self:
        ...
        if instance.__pydantic_extra__ and "dnssec_status" in instance.__pydantic_extra__:
            instance.__pydantic_extra__.pop("dnssec_status")
        return instance
