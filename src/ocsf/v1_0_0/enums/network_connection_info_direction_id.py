...
class NetworkConnectionInfoDirectionId(IntEnum):
    """The normalized identifier of the direction of the initiated connection, traffic, or email.

    See: https://schema.ocsf.io/1.0.0/data_types/network_connection_info_direction_id
    """

    UNKNOWN = 0  # Connection direction is unknown.
