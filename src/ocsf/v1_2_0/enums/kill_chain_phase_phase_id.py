...
class KillChainPhasePhaseId(IntEnum):
    """The cyber kill chain phase identifier.

    See: https://schema.ocsf.io/1.2.0/data_types/kill_chain_phase_phase_id
    """
    ...
    OTHER = 99  # The kill chain phase is not mapped. See the <code>phase</code> attribute, which contains a data source specific value.
