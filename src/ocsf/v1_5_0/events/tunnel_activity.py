...
class TunnelActivity(OCSFBaseModel):
    ...
    def _reconcile_siblings(cls, data: Any) -> Any:
        ...
        regular_siblings: list[tuple[str, str, type[SiblingEnum]]] = [
            ...
            ("tunnel_type_id", "tunnel_type", cls.TunnelTypeId),
        ]
