...
class EmailActivityActivityId(IntEnum):
    ...
    See: https://schema.ocsf.io/1.6.0/data_types/email_activity_activity_id
    """
    ...
    MTA_RELAY = 5  # Email processed by an MTA, typically combining send, receive, and scan operations into a single activity.
