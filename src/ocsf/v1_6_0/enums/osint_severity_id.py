"""The normalized severity level of the threat indicator, typically reflecting its potential impact or damage. enumeration."""

from enum import IntEnum


class OsintSeverityId(IntEnum):
    """The normalized severity level of the threat indicator, typically reflecting its potential impact or damage.

    See: https://schema.ocsf.io/1.6.0/data_types/osint_severity_id
    """
