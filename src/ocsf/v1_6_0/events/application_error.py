...
class ApplicationError(OCSFBaseModel):
    ...
    class EventTypeId(SiblingEnum):
        ...
        GENERAL_ERROR = 801
        TRANSLATION_ERROR = 802

        @classmethod
        def _get_label_map(cls) -> dict[int, str]:
            return {
                801: "General Error",
                802: "Translation Error",
            }
