...
class ApplicationSecurityPostureFindingStatusId(IntEnum):
    """The normalized status identifier of the Finding, set by the consumer.

    See: https://schema.ocsf.io/1.7.0/data_types/application_security_posture_finding_status_id
    """
    ...
    DELETED = 6  # The Finding was deleted. For example, it might have been created in error.
