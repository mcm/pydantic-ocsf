...
class AuthenticationLogonTypeId(IntEnum):
    ...
    See: https://schema.ocsf.io/1.7.0/data_types/authentication_logon_type_id
    """

    UNKNOWN = 0  # The logon type is unknown.
    SYSTEM = 1  # Used only by the System account, for example at system startup.
