...
class GroupManagementActivityId(IntEnum):
    ...
    See: https://schema.ocsf.io/1.7.0/data_types/group_management_activity_id
    """
    ...
    ADD_SUBGROUP = 7  # Add subgroup to a group.
    REMOVE_SUBGROUP = 8  # Remove subgroup from a group.
