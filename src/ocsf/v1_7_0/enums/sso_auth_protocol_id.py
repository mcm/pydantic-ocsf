"""The normalized identifier of the authentication protocol used by the SSO resource. enumeration."""

from enum import IntEnum


class SsoAuthProtocolId(IntEnum):
    """The normalized identifier of the authentication protocol used by the SSO resource.

    See: https://schema.ocsf.io/1.7.0/data_types/sso_auth_protocol_id
    """
