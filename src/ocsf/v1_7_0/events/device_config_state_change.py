...
class DeviceConfigStateChange(OCSFBaseModel):
    ...
    def _reconcile_siblings(cls, data: Any) -> Any:
        ...
        regular_siblings: list[tuple[str, str, type[SiblingEnum]]] = [
            ...
            ("prev_security_level_id", "prev_security_level", cls.PrevSecurityLevelId),
            ("security_level_id", "security_level", cls.SecurityLevelId),
